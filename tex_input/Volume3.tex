...
\begin{tikzpicture}
	\genealogytree{
		parent{
			c[male]{Forrest Ithamar Rettgers\\YYYY-YYYY}
			g[male]{Robert Rettgers}
			c[female]{Miriam Rettgers}
			c[female]{Joyce Rettgers}
			parent{
...
\input{det_ancestor_report_Rettgers_mod.tex}
...
\input{det_ancestor_report_Hartenstine_mod.tex}

\chapter{Ancestors of Floyd William Fett}

\input{det_ancestor_report_Fett_mod.tex}

\chapter{Ancestors of Florence Ethel Bechtel}

\input{det_ancestor_report_Bechtel_mod.tex}

\chapter{Endnotes}

\section{Ancestors of Ithamar Benedict Rettgers}

\input{det_ancestor_report_Rettgers_mod_notes.tex}

\section{Ancestors of Laura Tyson Hartenstine}

\input{det_ancestor_report_Hartenstine_mod_notes.tex}

\section{Ancestors of Floyd William Fett}

\input{det_ancestor_report_Fett_mod_notes.tex}

\section{Ancestors of Florence Ethel Bechtel}

\input{det_ancestor_report_Bechtel_mod_notes.tex}
