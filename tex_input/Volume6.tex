...
\begin{tikzpicture}
	\genealogytree[
		...
		child{
			...
			p[female]{Jewel Norene Josey\\XXXX-YYYY}
			child{
				g[female]{Lora Elizabeth Smith}
				p[male]{Curtis Thomas Carnell}
				c[male]{Donald Curtis}
				c[female]{Linda M}
				c[male]{Richard Loyd}
				c[female]{Vivian Louise}
			...
			child{				
				g[female]{Eunice Loise Smith}
				p[male]{Stanley}
				c[male]{child}
			}
			child{
				g[male]{Floyd Kendrick Smith}
				p[female]{wife}
				c[male]{child}
			}
			child{
				g[male]{Kenneth C Smith}
				p[female]{wife}
				c[male]{child}
			}
			child{
				g[male]{Gerald Lewis Smith}
				p[female]{wife}
				c[male]{child}
			}
			child{
				g[male]{Jimmie E Smith}
				p[female]{wife}
				c[male]{child}
			}
