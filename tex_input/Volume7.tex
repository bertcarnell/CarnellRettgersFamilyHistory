...
\begin{tikzpicture}
	\genealogytree[
		...
		child{
			...
			p[female]{Laura Tyson Hartenstine}
			child{
				g[male]{Forrest Ithamar Rettgers}
				p[female]{Ginny}
				c[female]{Robin}
			}
			child{
				g[male]{Robert Edgar Rettgers}
				p[female]{Marjorie Ethel Fett}
				c[female]{Sharon}
				c[female]{Jane}
				c[female]{Barb}
			}
			child{
				g[female]{Miriam Jane Rettgers}
				p[male]{Bud}
				c[female]{Jack}
				c[female]{Jill}
				c[female]{Lori}
...
\begin{tikzpicture}
	\genealogytree[
		...
		child{
			...
			child{
				g[female]{Clementine F Fett}
				p[male]{Black}
				c[male]{Michael}
			}
			child{
				g[female]{Gene Catherine Fett}
				p[male]{husband}
				c[male]{child}
			}
			child{
				g[female]{Marjorie Ethel Fett}
				p[male]{Robert Edgar Rettgers}
				c[female]{Sharon}
				c[female]{Jane}
				c[female]{Barb}
			}			
