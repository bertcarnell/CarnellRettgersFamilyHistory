...
\input{det_ancestor_report_Connell_mod.tex}
...
\input{det_ancestor_report_Langston_mod.tex}
			...
			parent{
				...
				parent{
					...
					parent{
						...
						parent{
							g[male]{William Allen\\1806-}
						}
						parent{
							g[female]{Martha Pierce}
						}
					}
				}
				parent{
...
\input{det_ancestor_report_Smith_mod.tex}
...
\input{det_ancestor_report_Josey_mod.tex}

\chapter{Endnotes}

\section{Connell Endnotes}

\input{det_ancestor_report_Connell_mod_notes.tex}

\section{Langston Endnotes}

\input{det_ancestor_report_Langston_mod_notes.tex}

\section{Smith Endnotes}

\input{det_ancestor_report_Smith_mod_notes.tex}

\section{Josey Endnotes}

\input{det_ancestor_report_Josey_mod_notes.tex}
